...
OpenTelemetry instrumentation for [AWS Bedrock](https://aws.amazon.com/bedrock/), designed to simplify LLM application development and production tracing and debugging.
