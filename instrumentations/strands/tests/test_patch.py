...
class TestBuildSystemPromptText:
    def test_simple_string_system_prompt(self):
        """Test that simple string system_prompt is extracted correctly."""
        result = _build_system_prompt_text("You are a helpful assistant.", None)
        assert result == "You are a helpful assistant."

    def test_system_prompt_content_blocks(self):
        """Test that system_prompt_content blocks are extracted correctly."""
    ...
    def test_system_prompt_content_takes_priority(self):
        """Test that system_prompt_content takes priority over system_prompt."""
    ...
    def test_no_system_prompt(self):
        """Test that None is returned when no system prompt is provided."""
        result = _build_system_prompt_text(None, None)
        assert result is None

    def test_empty_system_prompt_content(self):
        """Test fallback to string when system_prompt_content is empty."""
    ...
    def test_system_prompt_content_with_non_text_blocks(self):
        """Test that non-text blocks are ignored."""
        system_prompt_content = [
            {"text": "Instructions"},
            {"image": "some_image_data"},  # Should be ignored
