...
OpenTelemetry instrumentation for [Strands Agents SDK](https://github.com/strands-agents/sdk-python), designed to simplify LLM application development and production tracing and debugging.
