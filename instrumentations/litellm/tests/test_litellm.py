...
@pytest.mark.vcr()
def test_litellm_streaming(instrument, litellm_span_exporter):
    litellm_span_exporter.clear()
    model = "gpt-4o-mini"
...
@pytest.mark.vcr()
def test_litellm_tool_usage(instrument, litellm_span_exporter):
    litellm_span_exporter.clear()
    model = "gpt-4o-mini"
...
@pytest.mark.vcr()
@pytest.mark.asyncio()
async def test_litellm_async_completion(instrument, litellm_span_exporter):
    litellm_span_exporter.clear()
    model = "gpt-4o-mini"
    messages = [{"role": "user", "content": "Say this is a test"}]
