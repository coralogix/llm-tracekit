...
OpenTelemetry instrumentation for [LiteLLM](https://github.com/BerriAI/litellm), designed to simplify LLM application development and production tracing and debugging.
