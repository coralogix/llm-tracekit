...
"""Tests for create_agent().stream() flow instrumentation."""
...
@pytest.mark.vcr()
def test_create_agent_stream(span_exporter, instrument_langchain):
    """Test that create_agent().stream() creates proper spans with completion attributes."""
    agent = create_agent(
